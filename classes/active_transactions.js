...
ActiveTransactions.prototype = {
    ...
    add: function(new_transaction){
        ...
        if(this.user_id_to_transactions_map[new_transaction.buyer_user_id] == undefined){
            this.user_id_to_transactions_map[new_transaction.buyer_user_id] = [];
        }
        ...
        this.transaction_id_to_user_id_map[new_transaction._id].push(new_transaction.buyer_user_id);
        this.transaction_id_to_user_id_map[new_transaction._id].push(new_transaction.seller_user_id);
        ...
        this.transaction_id_to_user_id_map[new_transaction._id] = new_transaction.listing_id;
    ...
    remove: function(transaction_id){
        ...
        var index = user1_transactions.indexOf(transaction_id);
        ...
        var index = user2_transactions.indexOf(transaction_id);
        ...
        var index = listing_transactions.indexOf(transaction_id);
